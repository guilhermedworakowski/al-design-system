...
# ---------------- camada semantica ----------------
# nomenclatura: grupo-papel-variacao, sempre separado por hifen.
...
SEM = {
  ...
  # o unico token que usava o mesmo degrau nos dois temas. Com o neutro
  # acromatico o 600 escureceu e parou de se separar da superficie escura
  # (2.98:1), entao o escuro sobe para o 500 - borda clareia sobre fundo escuro,
  # que e o comportamento correto de qualquer forma.
...
PAIRS = [
  ...
  ('text-on-brand',   'bg-brand',          4.5, 'texto claro sobre a marca'),
  ('text-on-brand',   'bg-brand-hover',    4.5, 'texto claro sobre a marca em hover'),
  ('text-on-brand',   'bg-brand-active',   4.5, 'texto claro sobre a marca pressionada'),
  ('text-on-solid',   'bg-danger-active',  4.5, 'texto sobre o solido destrutivo pressionado'),
  ('bg-brand-hover',  'bg-canvas',         3.0, 'marca em hover contra a tela'),
  ('bg-brand-hover',  'bg-surface',        3.0, 'marca em hover em superficie'),
  ('bg-brand',        'bg-surface',        3.0, 'preenchimento de marca em superficie'),
  ('text-on-solid',   'bg-danger',         4.5, 'texto sobre o solido destrutivo'),
  ('text-on-solid',   'bg-success',        4.5, 'texto sobre o solido de sucesso'),
  ('text-on-solid',   'bg-warning',        4.5, 'texto sobre o solido de alerta'),
  ('text-on-solid',   'bg-info',           4.5, 'texto sobre o solido de info'),
